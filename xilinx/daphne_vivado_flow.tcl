...
proc daphne_create_block_design {cfg_name} {
    ...
    foreach constraint_file $cfg(constraint_files) {
        ...
        if {$constraint_basename in {"afe_capture_timing.tcl" "frontend_control_cdc.tcl" "timing_endpoint_cdc.tcl" "hermes_control_cdc.tcl" "fan_tach_cdc.tcl" "external_trigger_cdc.tcl"}} {
