...
set daphne_ip_cell_bind_root_default "selftrigger_plane_inst/legacy_core_readout_bridge_inst/legacy_deimos_readout_bridge_inst/daphne_top_inst"
...
if {[file exists $daphne_packaged_support_stage_dir]} {
    ...
    puts "INFO: Deleting older version of generated support source staging directory..."
    file delete -force $daphne_packaged_support_stage_dir
}
file mkdir $daphne_packaged_support_stage_dir
set daphne_packaged_support_vhdl {}
set daphne_packaged_support_names {}
foreach packaged_support_vhdl_src $daphne_packaged_support_vhdl_src {
    if {![file exists $packaged_support_vhdl_src]} {
        error "ERROR: Missing isolated packaged-IP support source at $packaged_support_vhdl_src"
    }
    set packaged_support_stage [file join $daphne_packaged_support_stage_dir [file tail $packaged_support_vhdl_src]]
    file copy -force $packaged_support_vhdl_src $packaged_support_stage
    lappend daphne_packaged_support_vhdl $packaged_support_stage
    lappend daphne_packaged_support_names [file tail $packaged_support_stage]
    set packaged_support_dir [file dirname $packaged_support_stage]
...
set ipRepoDir $daphne_ip_root

# # set repository for the AXI Quad SPI IP Unused
# set axiQuadDir ../ip_repo/daphne_ip/ips/cm
# set axiQuadXCIDir ../ip_repo/daphne_ip/ips/cm/axi_quad_spi_0.xci

# # set repository for the AXI IIC IP Unused
# set axiIICDir ../ip_repo/daphne_ip/ips/i2c
# set axiIICXCIDir ../ip_repo/daphne_ip/ips/i2c/axi_iic_0.xci

# set repository for BRAM controller IP axi4_lite_bram_ctrl_0
set bramRepoDir [file join $daphne_ip_root "src" "dune.daq_user_hermes_daphne_1.0" "src"]

# set repository for Ethernet IP
set ethernetRepoDir [file join $daphne_ip_root "src" "dune.daq_user_hermes_daphne_1.0" "src"]
...
set rtlDir [file join $daphne_ip_root "rtl"]
set tbDir [file join $daphne_ip_root "sim"]
set constDir [file join $daphne_ip_root "constraints"]
set xciDir [file join $daphne_ip_root "ips"]
set rtlDAQDir [file join $daphne_ip_root "src" "dune.daq_user_hermes_daphne_1.0" "src"]
set constDAQDir $rtlDAQDir
set tclConstDir $rtlDAQDir
...
#     FREQ_TOLERANCE_HZ 0
#     PHASE 0.0
#     CLK_DOMAIN daphne_selftrigger_bd_daphne_selftrigger_top_0
#     ASSOCIATED_BUSIF {}
#     ASSOCIATED_PORT {}
#     ASSOCIATED_RESET {}
#     INSERT_VIP 0
...
foreach plClkInterface $daphne_pl_clk_interfaces {
    ...
    if {[string match "afe_clk_*" $plClkInterface] || [string match "out_buff_clk" $plClkInterface] || [string match "clock_gen_debug" $plClkInterface]} {
...
ipx::add_file -name $XGUILoc -file_group $xpgui_files
