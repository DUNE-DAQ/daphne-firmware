...
set daphne_ip_root [file join $repo_root "ip_repo" "daphne3_ip"]
...
ipx::add_file -name [file join $daphne_ip_root "rtl" "daphne3.vhd"] -file_group $lang_synth
ipx::add_file -name [file join $daphne_ip_root "rtl" "daphne3.vhd"] -file_group $lang_sim
...
set daphne_ports [ipx::add_ports_from_hdl -top_level_hdl_file [file join $daphne_ip_root "rtl" "daphne3.vhd"] -top_module_name DAPHNE3 -include_dirs [file join $daphne_ip_root "rtl"] $daphne]

# create the generic parameters of the design based on the TOP level generic
set daphne_generics [ipx::add_model_parameters_from_hdl -top_level_hdl_file [file join $daphne_ip_root "rtl" "daphne3.vhd"] -top_module_name DAPHNE3 -include_dirs [file join $daphne_ip_root "rtl"] $daphne]
...
set daphne_bus_parameters {
    ...
    MAX_BURST_LENGTH 1
    PHASE 0.0
    CLK_DOMAIN DAPHNE_MEZ_SELFTRIGGER_V1_zynq_ultra_ps_e_0_0_pl_clk0
    NUM_READ_THREADS 1
    NUM_WRITE_THREADS 1
...
#     FREQ_TOLERANCE_HZ 0
#     PHASE 0.0
#     CLK_DOMAIN DAPHNE_MEZ_SELFTRIGGER_V1_DAPHNE3_0
#     ASSOCIATED_BUSIF {}
#     ASSOCIATED_PORT {}
#     ASSOCIATED_RESET {}
#     INSERT_VIP 0
        ...
        if {[llength $plClkBusParamVal] == 0} {
            ...
            if {$plClkBusParam eq "CLK_DOMAIN"} {
                if {[string match "eth_clk_n" $plClkInterface]} {
                    set_property VALUE DAPHNE_MEZ_SELFTRIGGER_V1_GTH0_REFCLK_N $plClk_param
                } elseif {[string match "eth_clk_p" $plClkInterface]} {
                    set_property VALUE DAPHNE_MEZ_SELFTRIGGER_V1_GTH0_REFCLK_P $plClk_param
                } else {
...
set XGUILoc [file join $daphne_ip_root "xgui" "DAPHNE3_v1_0.tcl"]
# create XGUI file
source -notrace [file join $script_dir "daphne3_xgui_gen.tcl"]
