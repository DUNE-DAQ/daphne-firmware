...
proc daphne_bd_intf_pin {cell_name pin_name} {
    return [get_bd_intf_pins "${cell_name}/${pin_name}"]
}
...
if {[catch {set daphne_top_cell [create_bd_cell -vlnv $daphneVlnv -type IP $block_cell_name]} errmsg]} {
...
set_property CONFIG.version $v_git_sha $daphne_top_cell
...
connect_bd_net -net daphne_selftrigger_top_afe0_mosi [daphne_bd_pin $block_cell_name afe0_mosi] [get_bd_ports AFE0_SDATA]
connect_bd_net -net daphne_selftrigger_top_afe0_sclk [daphne_bd_pin $block_cell_name afe0_sclk] [get_bd_ports AFE0_SCLK]
connect_bd_net -net daphne_selftrigger_top_afe12_mosi [daphne_bd_pin $block_cell_name afe12_mosi] [get_bd_ports AFE12_SDATA]
connect_bd_net -net daphne_selftrigger_top_afe12_sclk [daphne_bd_pin $block_cell_name afe12_sclk] [get_bd_ports AFE12_SCLK]
connect_bd_net -net daphne_selftrigger_top_afe34_mosi [daphne_bd_pin $block_cell_name afe34_mosi] [get_bd_ports AFE34_SDATA]
connect_bd_net -net daphne_selftrigger_top_afe34_sclk [daphne_bd_pin $block_cell_name afe34_sclk] [get_bd_ports AFE34_SCLK]
connect_bd_net -net daphne_selftrigger_top_afe_clk_n [daphne_bd_pin $block_cell_name afe_clk_n] [get_bd_ports afe_clk_n]
connect_bd_net -net daphne_selftrigger_top_afe_clk_p [daphne_bd_pin $block_cell_name afe_clk_p] [get_bd_ports afe_clk_p]
connect_bd_net -net daphne_selftrigger_top_afe_pdn [daphne_bd_pin $block_cell_name afe_pdn] [get_bd_ports AFE_PD]
connect_bd_net -net daphne_selftrigger_top_afe_rst [daphne_bd_pin $block_cell_name afe_rst] [get_bd_ports AFE_RST]
connect_bd_net -net daphne_selftrigger_top_afe_sen [daphne_bd_pin $block_cell_name afe_sen] [get_bd_ports afe_sen]
...
connect_bd_net -net daphne_selftrigger_top_dac_din [daphne_bd_pin $block_cell_name dac_din] [get_bd_ports DACS_MOSI]
connect_bd_net -net daphne_selftrigger_top_dac_ldac_n [daphne_bd_pin $block_cell_name dac_ldac_n] [get_bd_ports DACS_LDACN]
connect_bd_net -net daphne_selftrigger_top_dac_sclk [daphne_bd_pin $block_cell_name dac_sclk] [get_bd_ports DACS_SCLK]
connect_bd_net -net daphne_selftrigger_top_dac_sync_n [daphne_bd_pin $block_cell_name dac_sync_n] [get_bd_ports DACS_CS]
connect_bd_net -net daphne_selftrigger_top_eth0_tx_dis [daphne_bd_pin $block_cell_name eth0_tx_dis] [get_bd_ports SFP_GTH0_TX_DIS]
connect_bd_net -net daphne_selftrigger_top_eth0_tx_n [daphne_bd_pin $block_cell_name eth0_tx_n] [get_bd_ports TX0_GTH_N]
connect_bd_net -net daphne_selftrigger_top_eth0_tx_p [daphne_bd_pin $block_cell_name eth0_tx_p] [get_bd_ports TX0_GTH_P]
connect_bd_net -net daphne_selftrigger_top_fan_ctrl [daphne_bd_pin $block_cell_name fan_ctrl] [get_bd_ports FAN_CONTROL]
connect_bd_net -net daphne_selftrigger_top_hvbias_en [daphne_bd_pin $block_cell_name hvbias_en] [get_bd_ports VBIAS_EN]
connect_bd_net -net daphne_selftrigger_top_mux_a [daphne_bd_pin $block_cell_name mux_a] [get_bd_ports MUXA]
connect_bd_net -net daphne_selftrigger_top_mux_en [daphne_bd_pin $block_cell_name mux_en] [get_bd_ports MUX_EN]
connect_bd_net -net daphne_selftrigger_top_offset_ldac_n [daphne_bd_pin $block_cell_name offset_ldac_n] [get_bd_ports offset_ldac_n]
connect_bd_net -net daphne_selftrigger_top_offset_sync_n [daphne_bd_pin $block_cell_name offset_sync_n] [get_bd_ports offset_sync_n]
connect_bd_net -net daphne_selftrigger_top_sfp_tmg_tx_dis [daphne_bd_pin $block_cell_name sfp_tmg_tx_dis] [get_bd_ports sfp_tmg_tx_dis]
connect_bd_net -net daphne_selftrigger_top_trim_ldac_n [daphne_bd_pin $block_cell_name trim_ldac_n] [get_bd_ports trim_ldac_n]
connect_bd_net -net daphne_selftrigger_top_trim_sync_n [daphne_bd_pin $block_cell_name trim_sync_n] [get_bd_ports trim_sync_n]
connect_bd_net -net daphne_selftrigger_top_tx0_tmg_n [daphne_bd_pin $block_cell_name tx0_tmg_n] [get_bd_ports tx0_tmg_n]
connect_bd_net -net daphne_selftrigger_top_tx0_tmg_p [daphne_bd_pin $block_cell_name tx0_tmg_p] [get_bd_ports tx0_tmg_p]
