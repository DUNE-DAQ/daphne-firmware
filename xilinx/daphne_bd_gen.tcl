# elaborated TCL script file to create daphne_selftrigger_top's block design
# the script generates the .bd file needed to build daphne_selftrigger_top's .bit file, within the In-Memory Project
...
if {[catch {set daphne_selftrigger_top_0 [create_bd_cell -vlnv $daphneVlnv -type IP $block_cell_name]} errmsg]} {
    ...
    return 1
} elseif { $daphne_selftrigger_top_0 eq ""} {
...
set_property CONFIG.version $v_git_sha $daphne_selftrigger_top_0
...
connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins daphne_selftrigger_top/AFE_SPI_S_AXI]
...
connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins smartconnect_0/M02_AXI] [get_bd_intf_pins daphne_selftrigger_top/END_P_S_AXI]
connect_bd_intf_net -intf_net smartconnect_0_M03_AXI [get_bd_intf_pins smartconnect_0/M03_AXI] [get_bd_intf_pins daphne_selftrigger_top/FRONT_END_S_AXI]
...
connect_bd_intf_net -intf_net smartconnect_0_M05_AXI [get_bd_intf_pins smartconnect_0/M05_AXI] [get_bd_intf_pins daphne_selftrigger_top/SPI_DAC_S_AXI]
connect_bd_intf_net -intf_net smartconnect_0_M06_AXI [get_bd_intf_pins smartconnect_0/M06_AXI] [get_bd_intf_pins daphne_selftrigger_top/SPY_BUF_S_S_AXI]
connect_bd_intf_net -intf_net smartconnect_0_M07_AXI [get_bd_intf_pins smartconnect_0/M07_AXI] [get_bd_intf_pins daphne_selftrigger_top/STUFF_S_AXI]
connect_bd_intf_net -intf_net smartconnect_0_M08_AXI [get_bd_intf_pins smartconnect_0/M08_AXI] [get_bd_intf_pins daphne_selftrigger_top/TRIRG_S_AXI]
...
connect_bd_intf_net -intf_net smartconnect_0_M10_AXI [get_bd_intf_pins daphne_selftrigger_top/OUTBUFF_S_AXI] [get_bd_intf_pins smartconnect_0/M10_AXI] 
connect_bd_intf_net -intf_net smartconnect_0_M11_AXI [get_bd_intf_pins daphne_selftrigger_top/THRESH_S_AXI] [get_bd_intf_pins smartconnect_0/M11_AXI] 
...
connect_bd_net -net daphne_selftrigger_top_afe0_mosi [get_bd_pins daphne_selftrigger_top/afe0_mosi] [get_bd_ports AFE0_SDATA]
connect_bd_net -net daphne_selftrigger_top_afe0_sclk [get_bd_pins daphne_selftrigger_top/afe0_sclk] [get_bd_ports AFE0_SCLK]
connect_bd_net -net daphne_selftrigger_top_afe12_mosi [get_bd_pins daphne_selftrigger_top/afe12_mosi] [get_bd_ports AFE12_SDATA]
connect_bd_net -net daphne_selftrigger_top_afe12_sclk [get_bd_pins daphne_selftrigger_top/afe12_sclk] [get_bd_ports AFE12_SCLK]
connect_bd_net -net daphne_selftrigger_top_afe34_mosi [get_bd_pins daphne_selftrigger_top/afe34_mosi] [get_bd_ports AFE34_SDATA]
connect_bd_net -net daphne_selftrigger_top_afe34_sclk [get_bd_pins daphne_selftrigger_top/afe34_sclk] [get_bd_ports AFE34_SCLK]
connect_bd_net -net daphne_selftrigger_top_afe_clk_n [get_bd_pins daphne_selftrigger_top/afe_clk_n] [get_bd_ports afe_clk_n]
connect_bd_net -net daphne_selftrigger_top_afe_clk_p [get_bd_pins daphne_selftrigger_top/afe_clk_p] [get_bd_ports afe_clk_p]
connect_bd_net -net daphne_selftrigger_top_afe_pdn [get_bd_pins daphne_selftrigger_top/afe_pdn] [get_bd_ports AFE_PD]
connect_bd_net -net daphne_selftrigger_top_afe_rst [get_bd_pins daphne_selftrigger_top/afe_rst] [get_bd_ports AFE_RST]
connect_bd_net -net daphne_selftrigger_top_afe_sen [get_bd_pins daphne_selftrigger_top/afe_sen] [get_bd_ports afe_sen]
connect_bd_net -net daphne_selftrigger_top_cm_csn [get_bd_pins axi_quad_spi_0/ss_o] [get_bd_ports CM_CSn]
connect_bd_net -net daphne_selftrigger_top_cm_din [get_bd_pins axi_quad_spi_0/io0_o] [get_bd_ports CM_DIN]
connect_bd_net -net daphne_selftrigger_top_cm_sclk [get_bd_pins axi_quad_spi_0/sck_o] [get_bd_ports CM_SCLK]
connect_bd_net -net daphne_selftrigger_top_dac_din [get_bd_pins daphne_selftrigger_top/dac_din] [get_bd_ports DACS_MOSI]
connect_bd_net -net daphne_selftrigger_top_dac_ldac_n [get_bd_pins daphne_selftrigger_top/dac_ldac_n] [get_bd_ports DACS_LDACN]
connect_bd_net -net daphne_selftrigger_top_dac_sclk [get_bd_pins daphne_selftrigger_top/dac_sclk] [get_bd_ports DACS_SCLK]
connect_bd_net -net daphne_selftrigger_top_dac_sync_n [get_bd_pins daphne_selftrigger_top/dac_sync_n] [get_bd_ports DACS_CS]
connect_bd_net -net daphne_selftrigger_top_eth0_tx_dis [get_bd_pins daphne_selftrigger_top/eth0_tx_dis] [get_bd_ports SFP_GTH0_TX_DIS]
connect_bd_net -net daphne_selftrigger_top_eth0_tx_n [get_bd_pins daphne_selftrigger_top/eth0_tx_n] [get_bd_ports TX0_GTH_N]
connect_bd_net -net daphne_selftrigger_top_eth0_tx_p [get_bd_pins daphne_selftrigger_top/eth0_tx_p] [get_bd_ports TX0_GTH_P]
connect_bd_net -net daphne_selftrigger_top_fan_ctrl [get_bd_pins daphne_selftrigger_top/fan_ctrl] [get_bd_ports FAN_CONTROL]
connect_bd_net -net daphne_selftrigger_top_hvbias_en [get_bd_pins daphne_selftrigger_top/hvbias_en] [get_bd_ports VBIAS_EN]
connect_bd_net -net daphne_selftrigger_top_mux_a [get_bd_pins daphne_selftrigger_top/mux_a] [get_bd_ports MUXA]
connect_bd_net -net daphne_selftrigger_top_mux_en [get_bd_pins daphne_selftrigger_top/mux_en] [get_bd_ports MUX_EN]
connect_bd_net -net daphne_selftrigger_top_offset_ldac_n [get_bd_pins daphne_selftrigger_top/offset_ldac_n] [get_bd_ports offset_ldac_n]
connect_bd_net -net daphne_selftrigger_top_offset_sync_n [get_bd_pins daphne_selftrigger_top/offset_sync_n] [get_bd_ports offset_sync_n]
connect_bd_net -net daphne_selftrigger_top_sfp_tmg_tx_dis [get_bd_pins daphne_selftrigger_top/sfp_tmg_tx_dis] [get_bd_ports sfp_tmg_tx_dis]
connect_bd_net -net daphne_selftrigger_top_trim_ldac_n [get_bd_pins daphne_selftrigger_top/trim_ldac_n] [get_bd_ports trim_ldac_n]
connect_bd_net -net daphne_selftrigger_top_trim_sync_n [get_bd_pins daphne_selftrigger_top/trim_sync_n] [get_bd_ports trim_sync_n]
connect_bd_net -net daphne_selftrigger_top_tx0_tmg_n [get_bd_pins daphne_selftrigger_top/tx0_tmg_n] [get_bd_ports tx0_tmg_n]
connect_bd_net -net daphne_selftrigger_top_tx0_tmg_p [get_bd_pins daphne_selftrigger_top/tx0_tmg_p] [get_bd_ports tx0_tmg_p]
...
connect_bd_net -net Net1 [get_bd_pins SYSTEM_RESET/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins daphne_selftrigger_top/FRONT_END_S_AXI_ARESETN] [get_bd_pins daphne_selftrigger_top/SPY_BUF_S_S_AXI_ARESETN] [get_bd_pins daphne_selftrigger_top/END_P_S_AXI_ARESETN] [get_bd_pins daphne_selftrigger_top/SPI_DAC_S_AXI_ARESETN] [get_bd_pins daphne_selftrigger_top/AFE_SPI_S_AXI_ARESETN] [get_bd_pins daphne_selftrigger_top/TRIRG_S_AXI_ARESETN] [get_bd_pins daphne_selftrigger_top/STUFF_S_AXI_ARESETN] [get_bd_pins daphne_selftrigger_top/THRESH_S_AXI_ARESETN] [get_bd_pins daphne_selftrigger_top/OUTBUFF_S_AXI_ARESETN]
connect_bd_net -net afe0_miso_0_1 [get_bd_ports AFE0_MISO] [get_bd_pins daphne_selftrigger_top/afe0_miso]
connect_bd_net -net afe0_n_0_1 [get_bd_ports afe0_n] [get_bd_pins daphne_selftrigger_top/afe0_n]
connect_bd_net -net afe0_p_0_1 [get_bd_ports afe0_p] [get_bd_pins daphne_selftrigger_top/afe0_p]
connect_bd_net -net afe12_miso_0_1 [get_bd_ports AFE12_AFE_MISO] [get_bd_pins daphne_selftrigger_top/afe12_miso]
connect_bd_net -net afe1_n_0_1 [get_bd_ports afe1_n] [get_bd_pins daphne_selftrigger_top/afe1_n]
connect_bd_net -net afe1_p_0_1 [get_bd_ports afe1_p] [get_bd_pins daphne_selftrigger_top/afe1_p]
connect_bd_net -net afe2_n_0_1 [get_bd_ports afe2_n] [get_bd_pins daphne_selftrigger_top/afe2_n]
connect_bd_net -net afe2_p_0_1 [get_bd_ports afe2_p] [get_bd_pins daphne_selftrigger_top/afe2_p]
connect_bd_net -net afe34_miso_0_1 [get_bd_ports AFE34_AFE_MISO] [get_bd_pins daphne_selftrigger_top/afe34_miso]
connect_bd_net -net afe3_n_0_1 [get_bd_ports afe3_n] [get_bd_pins daphne_selftrigger_top/afe3_n]
connect_bd_net -net afe3_p_0_1 [get_bd_ports afe3_p] [get_bd_pins daphne_selftrigger_top/afe3_p]
connect_bd_net -net afe4_n_0_1 [get_bd_ports afe4_n] [get_bd_pins daphne_selftrigger_top/afe4_n]
connect_bd_net -net afe4_p_0_1 [get_bd_ports afe4_p] [get_bd_pins daphne_selftrigger_top/afe4_p]
...
connect_bd_net -net eth0_rx_n_0_1 [get_bd_ports RX0_GTH_N] [get_bd_pins daphne_selftrigger_top/eth0_rx_n]
connect_bd_net -net eth0_rx_p_0_1 [get_bd_ports RX0_GTH_P] [get_bd_pins daphne_selftrigger_top/eth0_rx_p]
connect_bd_net -net eth_clk_n_0_1 [get_bd_ports GTH0_REFCLK_N] [get_bd_pins daphne_selftrigger_top/eth_clk_n]
connect_bd_net -net eth_clk_p_0_1 [get_bd_ports GTH0_REFCLK_P] [get_bd_pins daphne_selftrigger_top/eth_clk_p]
connect_bd_net -net fan_tach_0_1 [get_bd_ports fan_tach] [get_bd_pins daphne_selftrigger_top/fan_tach]
connect_bd_net -net rx0_tmg_n_0_1 [get_bd_ports rx0_tmg_n] [get_bd_pins daphne_selftrigger_top/rx0_tmg_n]
connect_bd_net -net rx0_tmg_p_0_1 [get_bd_ports rx0_tmg_p] [get_bd_pins daphne_selftrigger_top/rx0_tmg_p]
connect_bd_net -net sfp_tmg_los_0_1 [get_bd_ports sfp_tmg_los] [get_bd_pins daphne_selftrigger_top/sfp_tmg_los]
connect_bd_net -net sysclk_n_0_1 [get_bd_ports sysclk_n] [get_bd_pins daphne_selftrigger_top/sysclk_n]
connect_bd_net -net sysclk_p_0_1 [get_bd_ports sysclk_p] [get_bd_pins daphne_selftrigger_top/sysclk_p]
connect_bd_net -net trig_IN_0_1 [get_bd_ports trig_IN] [get_bd_pins daphne_selftrigger_top/trig_IN] [get_bd_pins daphne_selftrigger_top/FORCE_TRIG]
connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins axi_intc_0/intr]
connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins SYSTEM_RESET/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins daphne_selftrigger_top/FRONT_END_S_AXI_ACLK] [get_bd_pins daphne_selftrigger_top/SPY_BUF_S_S_AXI_ACLK] [get_bd_pins daphne_selftrigger_top/END_P_S_AXI_ACLK] [get_bd_pins daphne_selftrigger_top/SPI_DAC_S_AXI_ACLK] [get_bd_pins daphne_selftrigger_top/AFE_SPI_S_AXI_ACLK] [get_bd_pins daphne_selftrigger_top/TRIRG_S_AXI_ACLK] [get_bd_pins daphne_selftrigger_top/STUFF_S_AXI_ACLK] [get_bd_pins daphne_selftrigger_top/THRESH_S_AXI_ACLK] [get_bd_pins daphne_selftrigger_top/OUTBUFF_S_AXI_ACLK]
...
connect_bd_net -net zynq_ultra_ps_e_0_pl_clk3 [get_bd_pins zynq_ultra_ps_e_0/pl_clk3] [get_bd_pins daphne_selftrigger_top/sysclk100]
...
assign_bd_address -offset 0x80000000 -range 0x04000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs daphne_selftrigger_top/AFE_SPI_S_AXI/reg0] -force
assign_bd_address -offset 0x84000000 -range 0x04000000 -with_name SEG_daphne_selftrigger_top_reg0_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs daphne_selftrigger_top/END_P_S_AXI/reg0] -force
assign_bd_address -offset 0x88000000 -range 0x04000000 -with_name SEG_daphne_selftrigger_top_reg0_2 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs daphne_selftrigger_top/FRONT_END_S_AXI/reg0] -force
assign_bd_address -offset 0xA0000000 -range 0x00010000 -with_name SEG_daphne_selftrigger_top_reg0_3 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs daphne_selftrigger_top/OUTBUFF_S_AXI/reg0] -force
assign_bd_address -offset 0x8C000000 -range 0x04000000 -with_name SEG_daphne_selftrigger_top_reg0_4 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs daphne_selftrigger_top/SPI_DAC_S_AXI/reg0] -force
assign_bd_address -offset 0x90000000 -range 0x04000000 -with_name SEG_daphne_selftrigger_top_reg0_5 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs daphne_selftrigger_top/SPY_BUF_S_S_AXI/reg0] -force
assign_bd_address -offset 0x94000000 -range 0x04000000 -with_name SEG_daphne_selftrigger_top_reg0_6 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs daphne_selftrigger_top/STUFF_S_AXI/reg0] -force
assign_bd_address -offset 0xA0010000 -range 0x00010000 -with_name SEG_daphne_selftrigger_top_reg0_7 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs daphne_selftrigger_top/THRESH_S_AXI/reg0] -force
assign_bd_address -offset 0x98000000 -range 0x04000000 -with_name SEG_daphne_selftrigger_top_reg0_8 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs daphne_selftrigger_top/TRIRG_S_AXI/reg0] -force
