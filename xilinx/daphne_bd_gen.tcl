...
if {$daphne_bd_shell_tcl ne ""} {
    source -notrace $daphne_bd_shell_tcl
}
...
proc daphne_bd_net_label {cell_name signal_name} {
...
daphne_connect_board_support $block_cell_name
daphne_connect_user_ip $block_cell_name

# create address segments
daphne_assign_user_ip_addresses $block_cell_name
daphne_assign_board_support_addresses

# create PFM attributes
daphne_apply_platform_metadata $daphne_pfm_name
