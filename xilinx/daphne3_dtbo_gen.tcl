...
set hw_xsa $hw_arg
if {$hw_xsa eq ""} {
    set hw_xsa [file join $out_dir daphne3_st_$git_sha.xsa]
}
...
createdts -hw $hw_xsa -zocl -platform-name daphne3_st_$git_sha -git-branch xlnx_rel_v2022.2 -overlay -out [file join $out_dir daphne3_st_$git_sha]
