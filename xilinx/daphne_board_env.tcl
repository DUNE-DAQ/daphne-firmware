...
proc daphne_resolve_board_profile {repo_root {board_name ""}} {
    ...
    foreach field {fpga_part board_part pfm_name constraint_file constraint_files platform_core modular_platform_core composable_platform_core user_ip_vlnv bd_name bd_wrapper_name build_name_prefix overlay_name_prefix ip_top_hdl_file ip_top_module ip_cell_name ip_component_identifier ip_display_name ip_xgui_file ip_cell_bind_root timing_endpoint_path} {
