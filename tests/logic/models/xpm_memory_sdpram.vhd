...
-- Equal-width,common-clock,single-cycle read subset only. This model is
...
begin
  ...
  assert CLOCKING_MODE="common_clock" and BYTE_WRITE_WIDTH_A=WRITE_DATA_WIDTH_A
    report "test model requires common clock and full-word writes" severity failure;
  process (clka)
