-- Copied from daphne_mezz_xc_sim/hdl/sync_fifo_fwft.vhd, git blob
-- e73043be4e8b95b57a488f73b3e776bf4ab3e8e8. Logical FWFT model;
-- programmable flags update without vendor pipeline latency.
library ieee;
