...
entity grouped_hermes_readout_ooc_src5_top is
  port (
    ...
    readout_i       : in  grouped_source_stream_array_t(4 downto 0);
...
end entity grouped_hermes_readout_ooc_src5_top;

architecture rtl of grouped_hermes_readout_ooc_src5_top is
begin
