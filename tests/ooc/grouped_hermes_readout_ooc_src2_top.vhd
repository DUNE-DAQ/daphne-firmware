...
entity grouped_hermes_readout_ooc_src2_top is
  port (
    ...
    readout_i       : in  grouped_source_stream_array_t(1 downto 0);
...
end entity grouped_hermes_readout_ooc_src2_top;

architecture rtl of grouped_hermes_readout_ooc_src2_top is
begin
