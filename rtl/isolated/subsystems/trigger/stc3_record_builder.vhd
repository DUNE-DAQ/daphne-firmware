...
architecture rtl of stc3_record_builder is
  ...
  constant FRAME_WORD_COUNT_C          : natural := HEADER_WORD_COUNT_C + (FRAME_BLOCK_COUNT_C * WORDS_PER_BLOCK_C);
  constant FIFO_READY_MARGIN_C         : natural := 12;
  constant FIFO_READY_THRESHOLD_C      : natural := FRAME_WORD_COUNT_C - FIFO_READY_MARGIN_C;
...
begin
  ...
  output_fifo_inst : entity work.sync_fifo_fwft
    generic map (
      ...
      DEPTH_G             => 4096,
      COUNT_WIDTH_G       => 13,
      PROG_EMPTY_THRESH_G => FIFO_READY_THRESHOLD_C,
