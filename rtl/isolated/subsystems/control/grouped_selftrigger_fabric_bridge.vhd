...
end entity grouped_selftrigger_fabric_bridge;

architecture rtl of grouped_selftrigger_fabric_bridge is
...
begin
  input_bridge_inst : entity work.legacy_selftrigger_inputs_bridge
    generic map (
  ...
  grouped_selftrigger_fabric_inst : entity work.grouped_selftrigger_fabric
    generic map (
      AFE_COUNT_G             => AFE_COUNT_G,
