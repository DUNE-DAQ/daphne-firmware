#!/usr/bin/env bash
set -euo pipefail
cd /home/marroyav/work/daphne-grouped32-1bae1c8-20260914/build/candidate-5e86a75-synth-launcher
...
export DAPHNE_FIRMWARE_ROOT=/home/marroyav/work/daphne-grouped32-5e86a75-synth-20260914
...
export DAPHNE_GIT_SHA=5e86a75
export DAPHNE_REMOTE_RUN_ID=synth-5e86a75-20260914
export DAPHNE_OUTPUT_DIR=/home/marroyav/work/daphne-grouped32-5e86a75-synth-20260914/xilinx/output-5e86a75
