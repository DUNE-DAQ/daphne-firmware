This branch implements **32-channel fixed512 continuation with eight shared four-channel builders**. See [architecture and local checks](docs/grouped32-implementation.md) and the [synthesis handoff](docs/grouped32-synthesis-handoff.md).
