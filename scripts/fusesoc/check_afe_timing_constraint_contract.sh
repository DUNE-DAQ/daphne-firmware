...
require_regex "sync_stat:[[:space:]]*entity work\\.pdts_cdc_snapshot" "$ENDPOINT_CORE_RTL" \
  "pdts_ep_core.vhd no longer transfers encoded endpoint status coherently into the control/register domain."
