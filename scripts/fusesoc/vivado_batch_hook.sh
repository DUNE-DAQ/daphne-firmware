...
append_env_tcl DAPHNE_TIMING_CLOCK_SOURCE
...
append_env_tcl DAPHNE_SKIP_POST_PLACE_CHECKPOINT
append_env_tcl DAPHNE_STOP_AFTER_SYNTH
append_env_tcl DAPHNE_DUMP_POST_SYNTH_DEBUG
append_env_tcl DAPHNE_SYNTH_DIRECTIVE
append_env_tcl DAPHNE_OPT_DIRECTIVE
append_env_tcl DAPHNE_PRE_PLACE_POWER_OPT
append_env_tcl DAPHNE_POST_PLACE_POWER_OPT
